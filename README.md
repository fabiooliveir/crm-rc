...
1. **Fase 1: Requisitos & Concepção de Produto** (`phase:1-requirements`)
   ...
   - 🛡️ [Requisitos Não-Funcionais e Diretrizes de Segurança LGPD](docs/requirements/RNF-Requisitos-Nao-Funcionais-e-LGPD.md) (`SDLC 1.3`)
   - 🗄️ [Modelagem Conceitual de Domínio e Dicionário de Dados](docs/requirements/MODELAGEM-CONCEITUAL-DE-DOMINIO.md) (`SDLC 1.4`)
